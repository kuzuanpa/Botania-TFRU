...
public final class ModCraftingRecipes {
	...
	public static IRecipe qjs;
	public static IRecipe xb;
	//TFC
	public static IRecipe recipemanaCrucible;
	...
	public static void init() {
		...
		xb = BotaniaAPI.getLatestAddedRecipe();
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.manasteelPick), new ItemStack(ModItems.MANA_STEELPickaxe), new ItemStack(ModItems.manaResource, 1, 3));
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.elementiumPick), new ItemStack(ModItems.elementiumPickaxe), new ItemStack(ModItems.manaResource, 1, 13));
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.terraPick), new ItemStack(ModItems.terrasteelPickaxe), new ItemStack(ModItems.manaResource, 1, 3));
		recipesPickaxe = BotaniaAPI.getLatestAddedRecipes(3);
		...
		//shui
				...
				addOreDictRecipe(new ItemStack(ModBlocks.manaCrucible),
						" C ", "SMS","SHS",
						'C', new ItemStack(TFCBlocks.crucible),
						'S', LibOreDict.LIVING_ROCK,
						'H',  LibOreDict.RUNE[1],
						'M', LibOreDict.MANA_STEEL);
				
				recipemanaCrucible = BotaniaAPI.getLatestAddedRecipe();
				addOreDictRecipe(new ItemStack(ModBlocks.manaForge),
						"M M", "SMS","SHS",
						'S', LibOreDict.LIVING_ROCK,
						'H',  LibOreDict.RUNE[1],
						'M', LibOreDict.MANA_STEEL);
				
				recipemanaForge = BotaniaAPI.getLatestAddedRecipe();
		// Mana Pool Recipe
		...
		addOreDictRecipe(new ItemStack(ModBlocks.runeAltar),
				...
				'R', LibOreDict.LIVING_ROCK,
				'S', LibOreDict.MANA_STEEL);
		recipesRuneAltar = BotaniaAPI.getLatestAddedRecipes(1);
		...
		addShapelessOreDictRecipe(new ItemStack(ModItems.lens, 1, 10), new ItemStack(ModItems.lens), "ingotAnyIron", "ingotGold");
		...
		addOreDictRecipe(new ItemStack(Blocks.lapis_block),
				"QQQ", "QQQ", "QQQ",
				'Q', new ItemStack(TFCItems.powder, 1, 6));
		qjs = BotaniaAPI.getLatestAddedRecipe();
		// Mana Distributor
		...
		GameRegistry.addShapelessRecipe(new ItemStack(TFCItems.fertilizer, Botania.gardenOfGlassLoaded ? 3 : 1), new ItemStack(Items.dye, 1, 15), new ItemStack(ModItems.dye, 1, Short.MAX_VALUE), new ItemStack(ModItems.dye, 1, Short.MAX_VALUE), new ItemStack(ModItems.dye, 1, Short.MAX_VALUE), new ItemStack(ModItems.dye, 1, Short.MAX_VALUE));
		recipeFertilizerPowder = BotaniaAPI.getLatestAddedRecipe();
		...
		addOreDictRecipe(new ItemStack(ModBlocks.pylon, 1, 1),
				" T ", "TPT", " G ",
				'T', LibOreDict.MANA_STEEL,
				'P', new ItemStack(ModBlocks.pylon),
				'G', LibOreDict.MANA_DIAMOND);
